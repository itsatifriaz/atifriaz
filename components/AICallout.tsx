...
/* Anthropic / Claude Code — official brand shape */
function ClaudeIcon() {
  return (
...
/* GitHub Copilot — official brand mark */
...
/* Cursor — their actual logomark: rounded square with a cursor arrow */
function CursorIcon() {
  return (
...
/* OpenAI — official geometric mark */
function OpenAIIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
